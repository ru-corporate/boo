doc = """	РАЗДЕЛ А СЕЛЬСКОЕ ХОЗЯЙСТВО, ОХОТА И ЛЕСНОЕ ХОЗЯЙСТВО
...
doc2 = """1	Растениеводство и животноводство, охота и предоставление соответствующих услуг в этих областях
...
OKVEDv2 = {int(a): b for [a, b] in [x.split('\t') for x in doc2.split('\n')]}
